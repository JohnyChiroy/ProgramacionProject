...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txtcantidadven->TabIndex = 271;
			// 
			// txtcodproducto05
			// 
			...
			this->txtcodproducto05->TabIndex = 270;
			// 
			// txtcodproducto04
			// 
			...
			this->txtcodproducto04->TabIndex = 269;
			// 
			// txtcodproducto03
			// 
			...
			this->txtcodproducto03->TabIndex = 268;
			// 
			// txtcodproducto02
			// 
			...
			this->txtcodproducto02->TabIndex = 267;
			// 
			// txtcodproducto01
			// 
			...
			this->txtcodproducto01->TabIndex = 266;
			// 
			// txtcategoria
			// 
