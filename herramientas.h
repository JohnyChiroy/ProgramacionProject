...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label8->Location = System::Drawing::Point(338, 44);
			...
			this->button5->Location = System::Drawing::Point(43, 275);
			...
			this->button4->Location = System::Drawing::Point(43, 221);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(409, 383);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(409, 342);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(409, 301);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(409, 261);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(409, 219);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(409, 180);
			...
			// txtcodproducto
			// 
			this->txtcodproducto->Location = System::Drawing::Point(409, 144);
			...
			this->label7->Location = System::Drawing::Point(238, 385);
			...
			this->label6->Location = System::Drawing::Point(238, 344);
			...
			this->label5->Location = System::Drawing::Point(238, 303);
			...
			this->label4->Location = System::Drawing::Point(238, 263);
			...
			this->label2->Location = System::Drawing::Point(238, 182);
			...
			this->label1->Location = System::Drawing::Point(238, 143);
			...
			this->pictureBox1->Location = System::Drawing::Point(745, 1);
